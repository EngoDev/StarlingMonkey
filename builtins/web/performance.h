...
public:
  ...
  static void set_time_origin(JSContext *cx, std::chrono::steady_clock::time_point time_origin);
  static std::chrono::steady_clock::time_point time_origin(JSContext *cx);
